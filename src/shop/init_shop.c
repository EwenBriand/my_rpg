...
void create_sprite_items(
    sprite_t *items, int i, const float *pos, const int *rect)
{
    sfTexture *texture =
        sfTexture_createFromFile("sprites/shop/items.png", NULL);
...
void create_sprite_shop(shop_t *shop)
{
    ...
    int rect[][2] = {{380, 480}, {96, 675}, {288, 578}, {0, 0}, {480, 672},
        {288, 385}, {192, 675}, {97, 580}, {480, 288}, {672, 288}};

    sfVector2f scale = (sfVector2f){5, 3};
    sfTexture *texture =
        sfTexture_createFromFile("sprites/shop/back.jpg", NULL);
...
void create_sprite_prize(shop_t *shop)
{
    ...
    shop->grey->texture =
        sfTexture_createFromFile("sprites/shop/back_grey.jpg", NULL);
    shop->green->texture =
        sfTexture_createFromFile("sprites/shop/back_green.jpg", NULL);
    shop->red->texture =
        sfTexture_createFromFile("sprites/shop/back_red.jpg", NULL);
